...
export default function BentoGrid() {
    ...
    return (
        <div ref={sectionRef} className="w-full grid grid-cols-2 lg:grid-cols-7 auto-rows-[minmax(300px,780px)] mt-20 gap-2">
            <div
                className="col-span-1 lg:col-span-3 relative overflow-hidden cursor-pointer rounded-[45px]">
                <motion.div 
                    initial={{scale: 1}}
            ...
            <div className="col-span-1 lg:col-span-2 rounded-[45px] border border-neutral-300 uppercase text-sm flex font-[500] justify-center items-center text-center px-[10%]">
            ...
            <div className="relative col-span-1 lg:col-span-2 overflow-hidden cursor-pointer rounded-[45px]">
                <motion.div 
                    initial={{scale: 1}}
                    whileHover={{scale: 1.05}}
                    transition={{ scale: { duration: 0.5, ease: "backOut" }}}
            ...
            <div className="col-span-1 lg:col-span-3 uppercase text-sm font-[500] px-[10%] text-center flex justify-center items-center border border-neutral-300 relative overflow-hidden cursor-pointer rounded-[45px]">
                <div>
